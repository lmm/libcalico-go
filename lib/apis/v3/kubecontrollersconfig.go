...
type KubeControllersConfigurationStatus struct {
	...
	RunningConfig KubeControllersConfigurationSpec `json:"runningConfig,omitempty" validate:"omitempty"`

	// EnvironmentVars contains the environment variables on the kube-controllers that influenced
	// the RunningConfig.
	EnvironmentVars map[string]string `json:"environmentVars,omitempty" validate:"omitempty"`
}
